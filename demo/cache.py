...
model = AutoModelForCausalLM.from_pretrained(model_id, torch_dtype=t.bfloat16, device_map=DEVICE)
tokenizer = AutoTokenizer.from_pretrained(model_id)
